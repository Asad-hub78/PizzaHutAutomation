...
public class pizzaHutAuto {
	...
	public void i_select_the_deal(String deal)  {
		WebElement panOption = driver.findElement(By.xpath("/html/body//div[3]/div[2]/div[2]/span/div/a[2]/div[3]/div/div/div/label/select"));
	...
	public void i_add_to_the_basket(String additem) {
		WebElement additem1 = driver.findElement(By.xpath("/html[1]/body/div/div/div/div/div[3]/div[2]/div[2]/span/div/a[2]/div[3]/div/button/span"));
		additem1.click();
		}
	@Then("I note down the price displayed on the screen")
	public void i_note_down_the_price_displayed_on_the_screen() {
		WebElement payableamount = driver.findElement(By.xpath("//span[contains(text(),'445.20')]"));
